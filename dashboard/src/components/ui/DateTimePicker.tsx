...
type DateTimePickerProps = React.HTMLAttributes<HTMLDivElement> & {
  value?: Date;
  onChange?: (date: Date | undefined) => void;
  disabled?: boolean;
  hourCycle?: 12 | 24;
  ...
  placeholder?: string;
  yearRange?: number;
  displayFormat?: { hour24?: string; hour12?: string; dateOnly?: string };
  hour24?: string;
  hour12?: string;
  showTime?: boolean;
...
const DateTimePicker = React.forwardRef<DateTimePickerRef, DateTimePickerProps>(
  (
    ...
    const handleSelect = (day: Date | undefined) => {
      ...
      const diff = day.getTime() - value.getTime();
    ...
    const initHourFormat = {
      ...
      dateOnly: displayFormat?.dateOnly ?? 'PPP',
    };
