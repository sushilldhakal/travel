...
import { getCompanyInfo, subscribe } from "@/http";
...
const UserFooter = () => {
    ...
    if (isLoading) {
        return (
            <footer className="relative z-1 bg-dark pb-5 pt-20 lg:pb-5 lg:pt-[120px]">
                <div className="container mx-auto">
                    <p className="text-center text-body-color">Loading...</p>
                </div>
            </footer>
        );
    }
    ...
    return (
        ...
        >
                            ...
                            <form onSubmit={handleSubscribe} className="w-full">
                                ...
                                <div className="flex">
                                    <Input
                                        ...
                                        className="mr-2 w-full rounded-md"
                                        value={email}
            ...
            <div className="mt-12 border-t border-stroke dark:border-dark-3">
                <div className="container mx-auto">
                    <div className="py-8">
